...
var DirectiveTestableModuleSubGenerator = yeoman.generators.Base.extend({
    ...
    askFor: function () {
        ...
        this.log(yosay('Welcome to the marvelous Directive sub-generator! I\'ll add for you the file to package.json and karma.conf.js.'));
        ...
        var prompts = [{
            ...
            type: 'input',
            name: 'directiveName',
            message: 'What is the name of the new ' + type + ' (without Directive suffix)?',
        ...
        this.prompt(prompts, function (props) {
            ...
            this.rawDirectiveName = props.directiveName;
            this.controllerName = this.rawDirectiveName + 'Controller';
            this.directiveName = this.rawDirectiveName + capitalizedType;
    ...
    app: function () {
        ...
        var fileDestinationPath = 'modules/' + folder + '/' + this.directiveName.toLowerCase() + '.js';
        ...
        if (this.addTests) {
            var testFileDestinationPath = 'test/spec/' + folder + '/' + this.directiveName.toLowerCase() + '-test.js';
...
module.exports = DirectiveTestableModuleSubGenerator;
